...
export const BudgetSidebar = observer(function BudgetSidebar({
  ...
  return (
    <Sheet open={!!budget} onOpenChange={(open) => !open && onClose()}>
      <SheetContent className="overflow-y-auto">
        <SheetHeader>
          <SheetTitle>Edit Budget</SheetTitle>
          <SheetDescription>Configure budget settings and goals.</SheetDescription>
        </SheetHeader>
                    ...
                    <div className="space-y-2">
                      ...
                      <label className="flex items-center gap-2 cursor-pointer">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-stone-500">
                            Target amount to assign each month
                          </p>
                        </div>
                      </label>
                    </div>
